...
"""
    ...
    if sketch_type == "portrait":
        return """你是一位专业的美术学院素描评审专家，请按照中国素描人像等级考试评分标准对提供的素描作品进行专业评价。
...
7. 艺术表现力（10%）：艺术感染力、个人风格、主题表达""" + base_prompt
        ...
        return """你是一位专业的美术学院素描评审专家，请按照中国素描静物素描等级考试评分标准对提供的素描作品进行专业评价。
...
7. 艺术表现力（10%）：艺术感、创意性、静物的主题表达""" + base_prompt
        ...
        return """你是一位专业的美术学院素描评审专家，请按照中国素描风景素描等级考试评分标准对提供的素描作品进行专业评价。
...
7. 艺术表现力（10%）：艺术感染力、风景的表现力、情感传达""" + base_prompt
        ...
        return """你是一位专业的美术学院素描评审专家，请按照中国素描石膏素描等级考试评分标准对提供的素描作品进行专业评价。
